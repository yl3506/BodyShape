jsPsych.plugins["collidingPage"] = (function() {

    var plugin = {};
  
    jsPsych.pluginAPI.registerPreload('collidingPage', 'stimulus', 'video');
    ...
    plugin.trial = function(display_element, trial) {
      ...
      var topic_html = 
      `
      <p style = "text-align : left"> <br><b>INSTRUCTIONS (CONTINUED)- EXAMPLE OF WHAT WE MEAN BY COLLIDING:</b>
      <br> Please hit the spacebar to play the video below.
      <br> Note the moment the AGENT collides with the <b>vanishing PATIENT</b>. The moment is highlighted in the video as "Colliding!".
      <br> This is the moment we want you to hit the space-bar for the second time to record the collision prediction.
      <br> For demonstration purpose, the PATIENT in the video below will not completely vanish, but in actual experiment it will.
      <br> <b>Please remember that the PATIENT still exists after it vanishes!</b>
      <br> If you want to watch again, press the "Restart" button below the video and repeat the process!
      </p>
      `
      ...
      video_html += "</video>";
      video_html += "</div>";
      video_html += `<p> We Will Then Show You Another Example of What We Mean By Colliding! Press "Continue" To See It!</p>`
      var played=0
      var playing = false
