jsPsych.plugins["practicePage"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      <br> First, Let's practice <b>without the PATIENT vanishing</b>.
      ...
      video_html += "</video>";
      video_html += "</div>";
      video_html += `<p>We will then show you an practice with vanishing PATIENT, hit the <b>"Continue"</b> button to proceed to the next practice!</p>`
      var played=0
      var playing=false
