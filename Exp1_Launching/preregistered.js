...
// var duration = 600; // the max duration used for capturing collision frames
var startMillis; // subtract the initial millis before first draw to begin at t_ratio=0
var xvelocity = 1; // 1 slow vs 2.4 fast
var blink_position = render.options.width / (4*2); // time to blink in patient object, 4 early vs 1.5 late. keep at 4 for all videos for preregistered

// ---------------------------------------------------------------------------------------------------------------------
// stimulus parameters
var distance_idx = 0;
var capturer = new CCapture({ format: 'png', framerate: 60 , name: 'A_concave_'+distance_idx});
...
// Vertices.fromPath('15 104 38 82 57 31 69 56 66 23 92 28 87 58 117 38 127 54 34 99 126 106 135 117 45 114 35 128'); // G front concave
// Vertices.fromPath('25 52 36 36 66 56 63 26 86 22 83 56 96 30 114 83 135 105 115 128 105 113 14 114 25 104 114 98'); // G back convex
...
var pointsB = Vertices.fromPath('104 20 42 80 25 125 127 117 85 107 104 98'); // A front concave
