jsPsych.plugins["practicePage2"] = (function() {

    var plugin = {};
  
    jsPsych.pluginAPI.registerPreload('practicePage2', 'stimulus', 'video');
    ...
    plugin.trial = function(display_element, trial) {
      ...
      // setup stimulus
      var topic_html = `
      <p style = "text-align : left"> <br><b>INSTRUCTIONS (CONTINUED) - PRACTICE:</b>
      <br> We are almost ready to start the study.
      <br> Let's practice <b>with the PATIENT vanishing</b>.
      <br> Hit the spacebar to begin the video below, then hit the spacebar again as soon as you see the <b>AGENT</b>
      <br> collided with the <b>PATIENT</b>!
      <br> In the actual experiment, the PATIENT may or may not vanish. 
      <br> <b>Please remember that the PATIENT still exists after it vanishes!</b>
      <br> The AGENT and PATIENT can be of random color, shape, moving direction (from left to right or right to left).
      <br> You could hit the <b>"Restart"</b> button at the bottom of the video to reset the video if you want to practice multiple times. 
      </p>
      `
      var video_html = topic_html+'<div>'
      ...
      video_html += "</video>";
      video_html += "</div>";
      video_html += `<p>If you are done with this practice, hit the <b>"Continue"</b> button to proceed to the actual experiment!</p>`
      var played=0
      var playing=false
      ...
      var after_response_space = function(info) {
        // after a valid response, the stimulus will have the CSS class 'responded'
        // which can be used to provide visual feedback that a response was recorded;
        // only record the first response
        if (info.key == " " && played == 0 && playing == false){
        ...
        else if (info.key == " " && played == 1 && playing == true){
          endingTime=info.rt,
          video_element.pause(),
      ...
      var keyboardListener = jsPsych.pluginAPI.getKeyboardResponse({
        callback_function: after_response_space,
        valid_responses: [" "],
