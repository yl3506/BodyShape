jsPsych.plugins["collidingR"] = (function() {

    var plugin = {};
  
    jsPsych.pluginAPI.registerPreload('collidingR', 'stimulus', 'video');
    ...
    plugin.trial = function(display_element, trial) {
      ...
      // setup stimulus
      var topic_html = `
      <p style = "text-align : left"> <br><b>INSTRUCTIONS (CONTINUED)- ANOTHER EXAMPLE OF WHAT WE MEAN BY COLLIDING:</b>
      <br> Please hit the spacebar to play the video below.
      <br> In this video, the PATIENT will <b>not vanish.</b>
      <br> Note the moment the AGENT collides with the PATIENT. The moment is highlighted in the video as "Colliding!".
      ...
      video_html += "</video>";
      video_html += "</div>";
      video_html += `<p> We will let you practice without the PATIENT vanishing first! Press the "Continue" button below the video to enter the pratice!</p>`
      var played=0
      var playing = false
