jsPsych.plugins["practicePage"] = (function() {

    var plugin = {};
  
    jsPsych.pluginAPI.registerPreload('practicePage', 'stimulus', 'video');
    ...
    plugin.trial = function(display_element, trial) {
      ...
      <br> First, Let's practice without the vanishing <b>PATIENT</b>.
      ...
      <br> In the actual experiment, the PATIENT may or may not vanish to hiding the PATIENT. 
      <br> The AGENT and PATIENT can be of random color, shape, moving direction (from left to right or right to left).
      <br> You could hit the <b>"Restart"</b> Button at the buttom of the video to reset the video if you want to practice multiple times. 
      </p>
      `
      ...
      video_html += "</video>";
      video_html += "</div>";
      video_html += `<p>If you are done with the practice, hit the <b>"Continue"</b> button to proceed to the actual experiment!</p>`
      var played=0
      var playing=false
