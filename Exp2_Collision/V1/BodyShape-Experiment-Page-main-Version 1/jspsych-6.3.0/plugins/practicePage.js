jsPsych.plugins["practicePage"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      <br> First, Let's practice without the screen.
      <br> Hit the spacebar to begin the video below, then hit the spacebar again as soon as you see the <b>AGENT</b> colliding with the <b>PATIENT</b>!
      <br> In the actual experiment, there may or may not be a SCREEN hiding the PATIENT. The AGENT and PATIENT can be of random color, shape, moving direction (from left to right or right to left).
      <br> You could hit the <b>"Restart"</b> Button at the buttom of the video if you want to practice to reset the video if you want to practice multiple time. 
      </p>
      `
      ...
      video_html += "</video>";
      video_html += "</div>";
      video_html += `<p>If you are ready, hit the <b>"Continue"</b> button to proceed to the actual experiment!</p>`
      var played=0
      var playing=false
